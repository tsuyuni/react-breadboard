...
export const breadBoardContext = createContext(null);
export const BreadBoard = ({ children, }) => {
    ...
    return (_jsxs(breadBoardContext.Provider, { value: { canvas }, children: [_jsx("canvas", { ref: canvasRef, id: "breadboard", width: 600, height: 400 }), children] }));
};
